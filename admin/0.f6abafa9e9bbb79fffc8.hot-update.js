...
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(194);
...
/* harmony import */ var _components_MapNavigation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(195);
...
var _default = {
  ...
  fromBlock: function fromBlock(match) {
    var mapVal = match[3];
    var map = JSON.parse(Object(_utils_escape__WEBPACK_IMPORTED_MODULE_4__["unescapeWithRegexp"])((mapVal || '') == '' ? '{}' : mapVal));
    return {
  ...
  toPreview: function toPreview(obj) {
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_MapNavigation__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      map: Object(_utils_escape__WEBPACK_IMPORTED_MODULE_4__["escapeWithRegexp"])(JSON.stringify(obj.map.toJS())),
      __source: {
...
//# sourceMappingURL=0.f6abafa9e9bbb79fffc8.hot-update.js.map