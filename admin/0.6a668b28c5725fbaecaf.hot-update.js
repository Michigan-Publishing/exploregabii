...
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(194);
...
/* harmony import */ var immutable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(207);
...
/* harmony import */ var _components_MapNavigation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(208);
...
var _default = {
  ...
  fromBlock: function fromBlock(match) {
    ...
    if (map && map.areas) {
      map.areas.forEach(function (area) {
        if (Array.isArray(area.coords)) {
          area.coords = JSON.stringify(area.coords);
        }
      });
    }
  ...
  toBlock: function toBlock(obj) {
    if (obj && obj.map && obj.map.areas) {
      ...
      console.log("OBJECT TO BLOCK", obj);
    }
...
//# sourceMappingURL=0.6a668b28c5725fbaecaf.hot-update.js.map