...
var _default = {
  ...
  toBlock: function toBlock(obj) {
    ...
    return ":::md-component MapNavigation name=\"" + escape(obj.name) + "\" imageSrc=\"" + Object(_utils_escape__WEBPACK_IMPORTED_MODULE_2__["escapeWithRegexp"])(obj.imageSrc) + "\"" + (" map={" + JSON.stringify(MAP) + "}");
  },
...
//# sourceMappingURL=0.530abe67be6159d5564a.hot-update.js.map