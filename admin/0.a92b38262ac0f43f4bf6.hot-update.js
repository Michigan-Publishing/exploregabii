...
/* harmony import */ var _utils_escape__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(181);
...
var _default = {
  ...
  fromBlock: function fromBlock(match) {
    ...
    console.log(match);
    console.log(match[3]);
    console.log(Object(_utils_escape__WEBPACK_IMPORTED_MODULE_3__["unescapeWithRegexp"])(match[3]));
    console.log(JSON.parse(Object(_utils_escape__WEBPACK_IMPORTED_MODULE_3__["unescapeWithRegexp"])(match[3])));
    var map = JSON.parse(Object(_utils_escape__WEBPACK_IMPORTED_MODULE_3__["unescapeWithRegexp"])(match[3]));
    var mapArray = [map.name, map.areas];
    return {
      name: Object(_utils_escape__WEBPACK_IMPORTED_MODULE_3__["unescapeWithRegexp"])(match[1]),
      imageSrc: Object(_utils_escape__WEBPACK_IMPORTED_MODULE_3__["unescapeWithRegexp"])(match[2]),
      map: immutable__WEBPACK_IMPORTED_MODULE_2___default.a.fromJS(map)
    };
  },
  toBlock: function toBlock(obj) {
    return ":::md-component MapNavigation name=\"" + escape(obj.name) + "\" imageSrc=\"" + Object(_utils_escape__WEBPACK_IMPORTED_MODULE_3__["escapeWithRegexp"])(obj.imageSrc) + "\"" + (" map=\"" + Object(_utils_escape__WEBPACK_IMPORTED_MODULE_3__["escapeWithRegexp"])(JSON.stringify(obj.map)) + "\"");
  },
...
//# sourceMappingURL=0.a92b38262ac0f43f4bf6.hot-update.js.map