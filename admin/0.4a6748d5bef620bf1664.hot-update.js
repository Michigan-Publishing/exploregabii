...
/* harmony import */ var _utils_escape__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(181);
...
function (_Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    if (this.mapper && this.mapper.computeCenter) {
      var areaCoords = JSON.parse(Object(_utils_escape__WEBPACK_IMPORTED_MODULE_6__["unescapeWithRegexp"])(this.props.map)).areas.reduce(function (accum, area) {
  ...
  _proto.render = function render() {
    ...
    try {
      map = JSON.parse(Object(_utils_escape__WEBPACK_IMPORTED_MODULE_6__["unescapeWithRegexp"])(mapString));
    } catch (ex) {}
    ...
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      ...
      __self: this
    }, imageSrc && react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react_image_mapper__WEBPACK_IMPORTED_MODULE_5___default.a, {
...
//# sourceMappingURL=0.4a6748d5bef620bf1664.hot-update.js.map